...
INSERT_BEAN = "INSERT INTO beans (name, method, rating) VALUE (?, ?, ?)"
...
def get_beans_by_name(connection, name):
    with connection:
        return connection.execute(GET_ALL_BEANS, (name,)).fetchall()


def get_best_preparation_for_bean(connection, rating):
    with connection:
